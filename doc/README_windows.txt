...
Setup
-----
Unpack the files into a directory and run koindashian-qt.exe.

If you have Microsoft Security Essentials, you need to add koindashian-qt.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select koindashian-qt.exe, OK, Save changes.
